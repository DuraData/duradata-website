...
const mobileNavigation = [
  ...
  { name: "Applications", href: "/admin/instructor-applications" },
  { name: "Courses", href: "/admin/courses", feature: "corporate" },
  { name: "Organizations", href: "/admin/organizations", feature: "corporate" },
  { name: "Subjects", href: "/admin/subjects", feature: "academic" },
  { name: "Free Tutorials", href: "/admin/tutorials", feature: "free" },
  { name: "Categories", href: "/admin/categories", feature: "corporate" },
  { name: "Enrollments", href: "/admin/enrollments", feature: "corporate" },
      ...
      >
        ...
        >
          ...
          <div className="p-4 space-y-2">
            {mobileNavigation.filter((item) => !item.feature || features[`${item.feature}LearningEnabled` as keyof typeof features]).map((item) => (
              <Link key={item.name} href={item.href} onClick={() => setMobileMenuOpen(false)} className="block rounded-md px-3 py-2.5 text-sm font-medium text-sidebar-foreground/80 transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground">
                {item.name}
              </Link>
            ))}
            <button
