...
const mobileNavigation = [
  ...
  { name: "My Courses", href: "/instructor/courses", icon: BookOpen, feature: "corporate" },
  { name: "My Subjects", href: "/instructor/subjects", icon: Layers, feature: "academic" },
    ...
    <>
      <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-border bg-background/95 px-4 backdrop-blur-sm lg:px-6">
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          {features.corporateLearningEnabled ? <Link href="/instructor/courses/new">
      ...
      >
        ...
        >
          ...
          <div className="p-4 space-y-1">
            {features.corporateLearningEnabled ? <Link
