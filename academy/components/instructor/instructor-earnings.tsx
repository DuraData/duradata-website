      ...
      <Card className="shadow-sm">
        ...
        <CardContent className="space-y-3">
          <p className="text-sm text-muted-foreground">
            For every paid enrollment, Duradata Academy automatically splits the sale as soon as the payment succeeds:
          </p>
          ...
          <p className="text-xs text-muted-foreground">
            This rate is set platform-wide by Duradata Academy admins and applies automatically to every sale — it
