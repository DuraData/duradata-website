...
export function HeroSection({ features }: { features: AcademyFeatures }) {
  return (
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col items-start text-left">
            <div className="inline-flex items-center gap-2 rounded-md border border-primary/20 bg-primary/5 px-3 py-1.5 text-sm font-medium text-primary">
              ...
              Built for ambitious professionals, teams, and lifelong learners
            </div>

            <h1 className="mt-6 max-w-xl text-balance text-4xl font-semibold tracking-tight text-foreground sm:text-5xl md:text-6xl">
              Learn for Work,
              <br />
              <span className="text-foreground/45">Growth, and Lasting Impact</span>
            </h1>

            <p className="text-subtitle mt-6 max-w-xl text-pretty">
              Access practical courses, free tutorials, and corporate training designed for individuals and teams.
            </p>

            <div className="mt-10 flex flex-col sm:flex-row items-center gap-4">
              {features.freeLearningEnabled ? <Link
                href="/learn"
