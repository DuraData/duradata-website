...
const navigation = [
  ...
  { name: "My Courses", href: "/internal-instructor/courses", icon: BookOpen, feature: "corporate" },
  { name: "My Subjects", href: "/internal-instructor/subjects", icon: GraduationCap, feature: "academic" },
  { name: "Free Tutorials", href: "/internal-instructor/tutorials", icon: Library, feature: "free" },
