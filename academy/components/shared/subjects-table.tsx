      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 border-b border-border">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            ZIMSEC/Cambridge-aligned subject packages for the Academic Learning Hub
          </p>
        </div>
        <Link href={newHref}>
        ...
        <div className="p-6">
          <Empty className="border border-dashed">
            <EmptyHeader>
              ...
              <EmptyDescription>
                Create a subject package to appear in the Academic Learning Hub for students to browse.
              </EmptyDescription>
            </EmptyHeader>
            <EmptyContent />
          </Empty>
