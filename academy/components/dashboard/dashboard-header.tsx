...
const mobileNavigation = [
  ...
  { name: "My Courses", href: "/dashboard/courses", icon: BookOpen, feature: "corporate" },
  { name: "Certificates", href: "/dashboard/certificates", icon: GraduationCap, feature: "corporate" },
  { name: "Achievements", href: "/dashboard/achievements", icon: Trophy, feature: "corporate" },
  { name: "Wishlist", href: "/dashboard/wishlist", icon: Heart, feature: "corporate" },
...
export function DashboardHeader() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("duradata-academy:notifications-updated", refresh)
    return () => {
      clearInterval(interval)
      window.removeEventListener("duradata-academy:notifications-updated", refresh)
    }
  }, [])
    ...
    <>
      <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-border bg-background/95 px-4 backdrop-blur-sm lg:px-6">
        ...
        <Link href="/dashboard" className="flex items-center gap-2 lg:hidden">
          ...
          <span className="text-base font-semibold text-foreground">Duradata Academy</span>
        </Link>
        ...
        >
          <div className="flex h-16 items-center justify-between border-b border-sidebar-border px-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-base font-semibold text-sidebar-foreground">Duradata Academy</span>
            </div>
            <button
