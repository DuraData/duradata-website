  ...
  return (
    <div className="mt-6">
      <div className="mb-3 flex items-center justify-between">
        <h2 className="text-lg font-semibold text-foreground">Academic Learning Hub</h2>
        <Link href="/academic-learning" className="text-sm font-medium text-primary hover:underline">
          Open hub
        </Link>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Link
          href={upcoming?.subjectPackageId ? `/academic-learning/${upcoming.subjectPackageId}` : "/academic-learning"}
          ...
          {activeEnrollments.length === 0 ? (
            ...
            <div className="mt-3 space-y-2">
              {activeEnrollments.slice(0, 6).map((e) => (
                <Link
                  key={e.id}
                  href={`/academic-learning/${e.subjectPackageId}`}
