            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              <Card className="shadow-sm">
                ...
                <CardContent className="space-y-3">
                  ...
                  <p className="text-sm font-medium text-foreground">academy@duradata.co.za</p>
                  <Button asChild>
                    <a href="mailto:academy@duradata.co.za">Email Support</a>
                  </Button>
                </CardContent>
              </Card>
              ...
              <Card className="shadow-sm">
                ...
                <CardContent className="space-y-3">
                  <p className="text-sm text-muted-foreground">
                    Want to teach on Duradata Academy? Apply and our team will review your details and course proposal.
                  </p>
