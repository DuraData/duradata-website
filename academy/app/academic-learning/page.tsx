...
export default function AcademicLearningHubPage() {
  return (
        ...
        <section className="relative overflow-hidden border-b border-border bg-gradient-to-br from-background via-muted/30 to-primary/10">
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 md:py-14">
            <div className="max-w-3xl">
              <p className="text-sm font-semibold uppercase tracking-wide text-primary">Academic Learning Hub</p>
              <h1 className="mt-2 text-3xl font-semibold tracking-tight text-foreground sm:text-4xl md:text-5xl">
                Structured academic support for every learner
              </h1>
              <p className="mt-4 max-w-2xl text-base text-muted-foreground md:text-lg">
                Explore standards-aligned subjects, revision resources, live lessons, and flexible monthly subscriptions.
              </p>
            </div>
          </div>
        </section>
