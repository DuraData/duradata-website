            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
              <div className="max-w-3xl">
                <div className="mb-3 flex flex-wrap gap-2">
                  <Badge variant="secondary">Academic Learning Hub</Badge>
                    ...
                    pkg.announcements.map((item) => (
                      <div key={item.id} className="rounded-lg border border-border bg-muted/20 p-4">
                        ...
                        <p className="mt-2 text-xs text-muted-foreground">
                          {item.author?.name ?? "Duradata Academy"} · {formatDateTime(item.createdAt)}
                        </p>
                      </div>
                    ))
                  )}
              ...
              <Card>
                ...
                <CardContent className="space-y-3 text-sm text-muted-foreground">
                  ...
                  <Button asChild variant="outline" className="w-full">
                    <Link href="/academic-learning">Back to hub</Link>
                  </Button>
                </CardContent>
              </Card>
            </div>
