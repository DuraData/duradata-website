...
const sections = [
  {
    ...
    body:
      "Duradata Academy collects the information you provide when you create an account, enroll in courses, request business training, or contact support. This may include your name, email address, role, course activity, and billing-related records.",
  },
  {
          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="mt-3 text-muted-foreground">
                Learn how Duradata Academy collects, uses, and protects personal information across the platform.
              </p>
            </div>
