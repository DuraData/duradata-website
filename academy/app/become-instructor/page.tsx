...
const faqs = [
  ...
  {
    q: "Do I need to have an existing Duradata Academy account?",
    a: "No. If your email isn’t registered, Duradata Academy will create a learner account for you when you apply so we can track your application.",
  },
  {
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h1 className="mt-6 text-3xl font-semibold tracking-tight text-foreground sm:text-4xl">
                Become an Instructor on Duradata Academy
              </h1>
            ...
            <div className="mt-10">
              <div className="text-center">
                <h2 className="text-2xl font-semibold tracking-tight text-foreground sm:text-3xl">Why Teach on Duradata Academy</h2>
              ...
              <Card className="lg:col-span-2 shadow-sm">
                ...
                <CardContent className="space-y-3 text-sm text-muted-foreground">
                  {[
                    ...
                    { step: "Review", text: "Our team validates applications to keep Duradata Academy trusted." },
            ...
            <div className="mt-10">
              <div className="text-center">
                ...
                <p className="mt-2 text-muted-foreground">Quick answers about teaching on Duradata Academy.</p>
              </div>
              ...
              <CardContent className="flex flex-col gap-4 p-6 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">Apply today and start building your instructor catalog on Duradata Academy.</p>
                  </div>
                </div>
                <Button asChild>
