...
const javascriptSections: SectionData[] = [
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        example: { title: "Choosing the right keyword", sourceCode: "const school = \"Duradata Academy\";\nlet streak = 3;\nstreak = streak + 1;\nconsole.log(school, streak);", expectedOutput: "Duradata Academy 4", explanation: "school never changes, so const fits. streak changes, so it needs let." },
      },
      {
...
const htmlSections: SectionData[] = [
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        example: { title: "An element with an attribute", sourceCode: "<p lang=\"en\">Welcome to Duradata Academy.</p>", expectedOutput: "Welcome to Duradata Academy.", explanation: "lang is an attribute that tells the browser (and assistive technology) the paragraph's language." },
      },
      {
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        example: { title: "A commented, coloured heading", sourceCode: "<!-- Section: hero banner -->\n<h1 style=\"color: #2563eb;\">Duradata Academy</h1>", expectedOutput: "Duradata Academy", explanation: "The comment never renders. The style attribute sets the heading's text colour using a hex code." },
      },
      {
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        example: { title: "An image with alt text", sourceCode: "<img src=\"logo.png\" alt=\"Duradata Academy logo\" width=\"120\">", expectedOutput: "[Duradata Academy logo]", explanation: "width sets a display size in pixels; alt is the text shown if logo.png cannot be found." },
      },
      {
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        exercise: { title: "Give an element a unique id", instructions: "Add an id of \"main-heading\" to this <h1> element.", starterCode: "<h1>Duradata Academy</h1>", expectedAnswer: "<h1 id=\"main-heading\">Duradata Academy</h1>" },
      },
      {
        ...
        example: { title: "A semantic page skeleton", sourceCode: "<body>\n  <header><h1>Duradata Academy</h1></header>\n  <nav><a href=\"/courses\">Courses</a></nav>\n  <main>\n    <section>\n      <h2>Free Learning</h2>\n    </section>\n  </main>\n  <footer><p>&copy; 2026 Duradata Academy</p></footer>\n</body>", expectedOutput: "Duradata Academy\nCourses\nFree Learning\n© 2026 Duradata Academy", explanation: "Each region has a clear role: header, nav, main content, and footer, instead of unlabelled divs." },
