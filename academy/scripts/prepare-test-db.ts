...
const env: NodeJS.ProcessEnv = { ...process.env, NODE_ENV: "test", ACADEMY_TEST_DATABASE_URL: testUrl, ACADEMY_DATABASE_URL: testUrl, ACADEMY_DIRECT_DATABASE_URL: testUrl }
