...
const DEFAULT_FROM_NAME = "Duradata Academy"
const DEFAULT_SUPPORT_EMAIL = "academy@duradata.co.za"
...
export async function sendPasswordResetEmail({
  ...
  await transporter.sendMail({
    from: getFromAddress(),
    to: toEmail,
    subject: "Reset your Duradata Academy password",
    text: [
      `Hello ${recipientName},`,
      "",
      "We received a request to reset your Duradata Academy password.",
    ...
    html: `
      <div style="font-family:Arial,sans-serif;line-height:1.6;color:#111827;max-width:560px;margin:0 auto;padding:24px 0;">
        <p style="margin:0 0 12px 0;font-size:20px;font-weight:700;">Duradata Academy</p>
        <p>Hello ${escapeHtml(recipientName)},</p>
        <p>We received a request to reset your Duradata Academy password.</p>
